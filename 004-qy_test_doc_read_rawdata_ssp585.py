...
cmor.dataset_json("./CMOR_CIESM_atm_ssp585.json")    
...
ncfile='/GPFS/cess9/qinyi/CMOR3/mid-data/'+casename[0]+'.cam.h0.'+str("%04d" % year[0])+'-'+str("%02d" % mon[0])+'_plev19.nc'
