...
cmor.dataset_json("./CMOR_CIESM_atm_4xCO2.json")    
...
ncfile='/GFPS8p/cess9/qinyi/CMOR3/mid-data/'+casename[0]+"/Revised/"+casename[0]+'.cam.h0.'+str("%04d" % year[0])+'-'+str("%02d" % mon[0])+'_plev19.nc_FillValue.nc'
...
for ivar in range(len(varin3d)):
	...
	#			ncfile='/home/share/lyl/work1/cesm1_2_1/CMOR3/cmor/my_tests/mid-data/'+casename[icase]+'.cam.h0.'+str(iyear)+'-'+str("%02d" % imon)+'_plev19.nc'
				ncfile='/GFPS8p/cess9/qinyi/CMOR3/mid-data/'+casename[icase]+'/Revised/'+casename[0]+'.cam.h0.'+str("%04d" % iyear)+'-'+str("%02d" % imon)+'_plev19.nc_FillValue.nc'
	...
	for icase in range(len(casename)):
		for iyear in year:
			for imon in mon:
				print("icase=, iyear=, imon=",str(icase), str(iyear), str(imon))
	#			ncfile='/home/share/lyl/work1/cesm1_2_1/CMOR3/cmor/my_tests/mid-data/'+casename[icase]+'.cam.h0.'+str(iyear)+'-'+str("%02d" % imon)+'_plev19.nc'
#				ncfile='/GFPS8p/cess9/qinyi/CMOR3/mid-data/'+casename[0]+'.cam.h0.'+str("%04d" % iyear)+'-'+str("%02d" % imon)+'_plev19.nc'
				ncfile='/GFPS8p/cess9/qinyi/CMOR3/mid-data/'+casename[icase]+'/Revised/'+casename[0]+'.cam.h0.'+str("%04d" % iyear)+'-'+str("%02d" % imon)+'_plev19.nc_FillValue.nc'
